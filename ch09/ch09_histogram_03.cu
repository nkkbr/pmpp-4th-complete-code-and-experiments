...
__global__ void histo_private_shared_memory_kernel(char *data, unsigned int length, unsigned int *histo){
...
int main(int argc, char **argv){
    ...
    histo_private_shared_memory_kernel<<<grid, block>>>(d_text_data, length, d_histo_gpu);
    ...
    */
    ...
    printf("Warmup complete for histo_private_shared_memory_kernel\n");
    ...
    printf("Execution time for histo_private_shared_memory_kernel: %f ms\n\n",milliseconds/BENCHMARK_REPEAT);
