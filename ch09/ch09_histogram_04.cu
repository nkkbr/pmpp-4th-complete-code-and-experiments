...
__global__ void histo_private_shared_memory_coarsening_contiguous(char *data, unsigned int length, unsigned int *histo){
...
int main(int argc, char **argv){
    ...
    histo_private_shared_memory_coarsening_contiguous<<<grid, block>>>(d_text_data, length, d_histo_gpu);
    ...
    */
    ...
    printf("Warmup complete for histo_private_shared_memory_coarsening_contiguous\n");
    ...
    printf("Execution time for histo_private_shared_memory_coarsening_contiguous: %f ms\n\n",milliseconds/BENCHMARK_REPEAT);
